...
export declare class RefreshScheduler {
    ...
    preAggregationPartitions(context: any, queryingOptions: PreAggregationsQueryingOptions): Promise<any[]>;
     ...
     */
    getCachedBuildJobs(context: RequestContext, tokens: string[]): Promise<{
        job: PreAggJob | null;
        token: string;
    }[]>;
}
