...
const variables = {
    ...
    scheduledRefreshBatchSize: () => (0, env_var_1.get)('CUBEJS_SCHEDULED_REFRESH_BATCH_SIZE')
        .default('1')
        .asInt(),
    nativeSqlPlanner: () => (0, env_var_1.get)('CUBEJS_NATIVE_SQL_PLANNER').asBool(),
    /** ****************************************************************
     * Common db options                                               *
     ***************************************************************** */
    /**
     ...
     */
    fireboltAccount: ({ dataSource }) => (process.env[keyByDataSource('CUBEJS_FIREBOLT_ACCOUNT', dataSource)]),
    /** ****************************************************************
     * Hive Driver                                                     *
     ***************************************************************** */
    /**
