...
const http_table_js_1 = require("./http-table.js");
class HttpQuery {
    constructor() {
        this.bb = null;
        this.bb_pos = 0;
    ...
    inlineTables(index, obj) {
        ...
        return offset ? (obj || new http_table_js_1.HttpTable()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
    }
    inlineTablesLength() {
        const offset = this.bb.__offset(this.bb_pos, 8);
