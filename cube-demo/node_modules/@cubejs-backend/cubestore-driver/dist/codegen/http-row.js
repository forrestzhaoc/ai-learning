...
exports.HttpRow = void 0;
const flatbuffers = __importStar(require("flatbuffers"));
const http_column_value_js_1 = require("./http-column-value.js");
class HttpRow {
    constructor() {
        this.bb = null;
        this.bb_pos = 0;
    ...
    values(index, obj) {
        ...
        return offset ? (obj || new http_column_value_js_1.HttpColumnValue()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
    }
    valuesLength() {
        const offset = this.bb.__offset(this.bb_pos, 4);
...
//# sourceMappingURL=http-row.js.map