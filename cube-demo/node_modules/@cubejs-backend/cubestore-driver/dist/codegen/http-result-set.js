...
exports.HttpResultSet = void 0;
const flatbuffers = __importStar(require("flatbuffers"));
const http_row_js_1 = require("./http-row.js");
class HttpResultSet {
    constructor() {
        this.bb = null;
        this.bb_pos = 0;
    ...
    rows(index, obj) {
        ...
        return offset ? (obj || new http_row_js_1.HttpRow()).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
    }
    rowsLength() {
        const offset = this.bb.__offset(this.bb_pos, 6);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
...
//# sourceMappingURL=http-result-set.js.map