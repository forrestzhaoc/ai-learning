...
const YamlCompiler_1 = require("./YamlCompiler");
const prepareCompiler = (repo, options = {}) => {
    const nativeInstance = options.nativeInstance || new native_1.NativeInstance();
    ...
    const yamlCompiler = new YamlCompiler_1.YamlCompiler(cubeSymbols, cubeDictionary, nativeInstance);
    const transpilers = [
    ...
    return {
        ...
        compilerId: (0, uuid_1.v4)(),
    };
};
exports.prepareCompiler = prepareCompiler;
const compile = (repo, options) => {
    const compilers = (0, exports.prepareCompiler)(repo, options);
