...
class JoinGraph {
    ...
    buildJoinEdges(cube, errorReporter) {
        return ramda_1.default.compose(ramda_1.default.filter(ramda_1.default.identity), ramda_1.default.map(join => {
            ...
            if (!this.cubeEvaluator.primaryKeys[join[1].from].length &&
