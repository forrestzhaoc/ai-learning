export declare class ParamAllocator {
    ...
    buildSqlAndParams(annotatedSql: string, exportAnnotatedSql?: boolean, shouldReuseParams?: boolean): [string, unknown[]];
    allocateParam(param: any): string;
    protected paramPlaceHolder(paramIndex: any): string;
}
//# sourceMappingURL=ParamAllocator.d.ts.map